...
namespace GameVanilla.Game.Common
{
    ...
    public class GameConfiguration
    {
        ...
        public GameConfiguration()
        {
            ...
            spinWheelItems.Add(new SpinWheelItem { type = DailyBonusType.Coins5, amount = 150 });
            spinWheelItems.Add(new SpinWheelItem { type = DailyBonusType.Coins6, amount = 400 });
            spinWheelItems.Add(new SpinWheelItem { type = DailyBonusType.Coins6, amount = 700 });
        }
