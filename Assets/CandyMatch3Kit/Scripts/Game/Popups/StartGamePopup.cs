...
#pragma warning disable 649
        ...
        [SerializeField]
        private TMPro.TMP_Text youGetText;
#pragma warning restore 649
        ...
        public void LoadLevelData(int levelNum)
        {
            ...
            if (levell > 0 && levell < 51)
            {
                youGetText.text += "60 TTcoin"; 
            }
            else if (levell > 50 && levell < 101)
            {
                youGetText.text += "60 TTcoin";
            }
            else if (levell > 100 & levell < 151)
            {
                youGetText.text += "80 TTcoin";
            }
            else if (levell > 150)
            {
                youGetText.text += "100 TTcoin";
            }
