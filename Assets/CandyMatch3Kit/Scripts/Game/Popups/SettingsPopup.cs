...
#pragma warning restore 649
        ...
        {
            base.Start();
            if (!PlayerPrefs.HasKey("avatar_selected"))
            {
        ...
        public void SocialMedia(string platform)
        {
            switch (platform)
            {
                case "instagram":
                    Application.OpenURL("https://instagram.com/ttcoinofficial");
                    break;
                case "youtube":
                    Application.OpenURL("https://www.youtube.com/channel/UCw4ctJY-VD12hwHuHl1D9kw");
                    break;
                case "x":
                    Application.OpenURL("https://twitter.com/ttcoinofficial");
                    break;
                case "telegram":
                    Application.OpenURL("https://t.me/ttcoinofficial");
                    break;
            }
        }
    }
