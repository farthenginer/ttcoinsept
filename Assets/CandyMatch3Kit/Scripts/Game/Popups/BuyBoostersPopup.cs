...
#pragma warning restore 649
	    ...
	    {
		    base.Start();
		    CheckCoinFromFirestoreWithGoogle();
	    }
		public async void CheckCoinFromFirestoreWithGoogle()
        {
			await GoogleAuthentication.Instance.FetchTTCoinFromFirestore();
			var coins = UserData.Instance.TTCoin;
	    ...
	    public async void OnBuyButtonPressed()
	    {
		    ...
		    if (gameScene != null)
		    {
			    ...
			    else
			    {
					...
					await GoogleAuthentication.Instance.SpendTTCoin(cost);
				}
			}
	    }
	}
