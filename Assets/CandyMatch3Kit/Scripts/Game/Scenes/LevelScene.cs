...
#pragma warning restore 649
        ...
        private void Start()
        {
            SetLevelSceneDetails();
            InvokeRepeating("detectLive",1,15);
        }
        async void detectLive()
        {
            await GoogleAuthentication.Instance.CheckAndGetOrSaveLifeTime();
        }
        async void SetLevelSceneDetails()
        {
