...
#pragma warning restore 649
        ...
        async void getDataRew()
        {
            ...
            string dateSTR = await TimeAPIClient.ExtractDateTimeString();
            DateTime dateNow;
            DateTime.TryParse(dateSTR, out dateNow);
        ...
        private async void AwardDailyBonus()
        {
            ...
            DateTime dateNow;
            DateTime.TryParse(dateSTR, out dateNow);
            var dateToday = dateNow.Subtract(DateTime.Today);
